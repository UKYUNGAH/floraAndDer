            ...
            <div class="cart-list">
                ...
                <span class="cl-list-3">
                    <span class="cart-count">
                        ...
                        <span class="cart-quantity" data-index="${i}">${
      saveCart[i].quantity
    }</span>                        
                ...
                <span class="cl-list-4">
                    <span class="cart-price">${saveCart[
                      i
...
function addItemToCart(newItem) {
  const existingItemIndex = saveCart.findIndex(
...
function refreshCartDisplay() {
  ...
  productsQuantity.textContent = saveCart.reduce(
...
document.querySelectorAll(".cart-common-btn").forEach((btn) => {
  btn.addEventListener("click", () => {
    ...
    const newQuantity = parseInt(
      btn.parentElement.parentElement.querySelector(".cart-quantity")
        .textContent,
      10
    );
    // 새로 설정할 수량 가져오기
